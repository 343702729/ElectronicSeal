...
public class DialogHelper {
    ...
    public static void showPermissionDialogWithMsg(final Context context, String msg) {
        new AlertDialog.Builder(context)
                .setTitle("提示信息")
                .setMessage(String.format("当前应用缺少%s权限，该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。",msg))
//                .setMessage(msg)
